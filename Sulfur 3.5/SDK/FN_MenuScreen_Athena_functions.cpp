...
{
	static auto fn = UObject::FindObject<UFunction>("Function MenuScreen_Athena.MenuScreen_Athena_C.UserFocus");

	UMenuScreen_Athena_C_UserFocus_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function MenuScreen_Athena.MenuScreen_Athena_C.EvaluateGraphExposedInputs_ExecuteUbergraph_MenuScreen_Athena_AnimGraphNode_BlendListByInt_287AF5964C1BE390191EF89CB53D768D");

	UMenuScreen_Athena_C_EvaluateGraphExposedInputs_ExecuteUbergraph_MenuScreen_Athena_AnimGraphNode_BlendListByInt_287AF5964C1BE390191EF89CB53D768D_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function MenuScreen_Athena.MenuScreen_Athena_C.EvaluateGraphExposedInputs_ExecuteUbergraph_MenuScreen_Athena_AnimGraphNode_BlendListByInt_6443F71D474774C8ECFB2A9F1ACC1D7A");

	UMenuScreen_Athena_C_EvaluateGraphExposedInputs_ExecuteUbergraph_MenuScreen_Athena_AnimGraphNode_BlendListByInt_6443F71D474774C8ECFB2A9F1ACC1D7A_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function MenuScreen_Athena.MenuScreen_Athena_C.BlueprintUpdateAnimation");
...
void UMenuScreen_Athena_C::ExecuteUbergraph_MenuScreen_Athena(int EntryPoint)
{
	static auto fn = UObject::FindObject<UFunction>("Function MenuScreen_Athena.MenuScreen_Athena_C.ExecuteUbergraph_MenuScreen_Athena");

	UMenuScreen_Athena_C_ExecuteUbergraph_MenuScreen_Athena_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function MenuScreen_Athena.MenuScreen_Athena_C.MenuScreenDispatcher__DelegateSignature");

	UMenuScreen_Athena_C_MenuScreenDispatcher__DelegateSignature_Params params;
