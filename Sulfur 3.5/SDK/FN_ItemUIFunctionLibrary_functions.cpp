...
static void UItemUIFunctionLibrary_C::Truncate_Integer_Value(int Value, int Min_Fractional_Digits, int Max_Fractional_Digits, class UObject* __WorldContext, struct FText* Formatted_Value)
{
...
static void UItemUIFunctionLibrary_C::Convert_Tier_To_Integer(TEnumAsByte<EFortItemTier> Tier, class UObject* __WorldContext, int* Numeric_Tier)
{
...
static void UItemUIFunctionLibrary_C::ParseLevelRequiredFromString(const struct FString& inString, class UObject* __WorldContext, int* outInt)
{
